...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-color-border-default bg-color-surface text-color-text-primary px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}
    >
