...
export function Sidebar() {
  ...
  return (
    <aside className={`transition-all duration-300 ${isExpanded ? 'w-64' : 'w-16'} bg-color-bg-secondary dark:bg-color-bg-primary h-fill rounded-2xl`}>
                ...
                <>
                  ...
                  <div
                    ...
                    className={`w-full 
                      ...
                      text-color-text-primary 
                      transition-colors 
                      ${theme === 'dark' ? 'bg-color-surface' : 'bg-color-primary'}`}>
